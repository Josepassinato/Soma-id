...
const translations = {
  pt: {
    ...
    // Import from URL
    import_url: "Importar",
    import_from_link: "Importar de Link",
    import_description: "Cole o link de um documento de cotação (Adobe Acrobat, Google Drive, etc.) e a IA irá extrair automaticamente todas as especificações do projeto.",
    document_url: "URL do Documento",
    supported_links: "Links suportados",
