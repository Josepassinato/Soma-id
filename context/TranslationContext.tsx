...
const translations = {
  pt: {
    ...
    structured_briefing: "Briefing Estruturado",
    cabinetry_quotation_style: "Modelo de Cotação de Marcenaria",
    client_info: "Dados do Cliente",
    project_areas: "Áreas do Projeto",
    specifications: "Especificações",
    review: "Revisão",
    project_address: "Endereço do Projeto",
    project_date: "Data do Projeto",
    select_project_areas: "Selecione as áreas que receberão marcenaria customizada:",
    selected_areas: "Áreas Selecionadas",
    remove: "Remover",
    cabinet_style: "Estilo do Armário",
    door_type: "Tipo de Porta",
    box_material: "Material da Caixa",
    door_material: "Material da Porta",
    finish: "Acabamento",
    hinges: "Dobradiças",
    slides: "Corrediças",
    dimensions_layout: "Dimensões/Layout",
    special_components: "Componentes Especiais",
    area_notes: "Observações da Área",
    additional_notes_placeholder: "Notas adicionais sobre esta área...",
    included: "Incluído",
    excluded: "Não Incluído",
    general_notes: "Observações Gerais",
    general_notes_placeholder: "Observações gerais sobre o projeto...",
    address: "Endereço",
    // Import from URL
    import_url: "Importar",
    import_from_link: "Importar de Links",
    import_description: "Cole os links dos documentos de cotação (Adobe Acrobat, Google Drive, etc.) e a IA irá extrair automaticamente todas as especificações. Projetos grandes podem ter 2-3 documentos.",
    document_urls: "URLs dos Documentos",
    paste_multiple_links: "Cole um link por linha. Suporta Adobe Acrobat, Google Drive, Dropbox.",
    links_detected: "link(s) detectado(s)",
    analyzing_documents: "Analisando documentos",
    analyze_and_import: "Analisar e Importar com IA",
    or: "OU",
    fill_manually: "Preencher Manualmente",
    // Multi-environment project
    multi_environment_project: "Projeto Multi-Ambientes Detectado",
    multi_environment_description: "A IA identificou múltiplos ambientes no projeto. Selecione quais ambientes você deseja criar como projetos individuais.",
    environments_detected: "Ambientes Identificados",
    select_all: "Selecionar Todos",
    deselect_all: "Desmarcar Todos",
    projects_to_create: "projeto(s) a criar",
    each_area_separate_project: "Cada ambiente será um projeto individual no sistema",
    docs_analyzed: "doc(s) analisados",
    edit_specifications: "Editar Especificações",
    ...
    industrial_identity: "Identidade Industrial",
    document: "Documento",
    ...
    value: "Valor",
    unit: "Unidade",
    dimension_preview: "Visualização das Dimensões",
    digital_twin_render: "Render Digital Twin",
    render_generated_by_ai: "Imagem gerada por IA - SOMA-ID Engine",
    reference_photo: "Foto de Referência",
  ...
  en: {
    ...
    industrial_identity: "Industrial Identity",
    document: "Document",
    ...
    value: "Value",
    unit: "Unit",
    dimension_preview: "Dimension Preview",
    digital_twin_render: "Digital Twin Render",
    render_generated_by_ai: "AI-generated image - SOMA-ID Engine",
  ...
  es: {
    ...
    loaded: "Cargado",
    pdf_ready: "PDF listo para análisis",
